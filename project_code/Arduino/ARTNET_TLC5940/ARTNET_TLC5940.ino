...
void loop() {
  ...
  if(packetSize) {
    ...
    */
    ...
    Udp.read(packetBuffer,2000);//UDP_TX_PACKET_MAX_SIZE
    ...
    */
    ...
    for(int m=1;m<dmxsize;m+=3){
      /*Serial.print(buffer_dmx[m]);
      Serial.print(", ");
      ...
      */
      if(ledcount<25){
        //Serial.print(buffer_dmx[m+1]);
        Tlc.set(ledcount, buffer_dmx[m]*8);
        ledcount++;
    ...
    /*Tlc.set(27, buffer_dmx[1]*4);
    Tlc.set(28, buffer_dmx[5]*4);
    Tlc.set(29, buffer_dmx[9]*4);
    Tlc.set(30, buffer_dmx[13]*4);
    Tlc.set(31, buffer_dmx[17]*4);
    Tlc.set(32, buffer_dmx[21]*4);*/
    Tlc.update();  
  }  
}
