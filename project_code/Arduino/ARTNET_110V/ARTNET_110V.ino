...
void setup() {
  ...
  //pinMode(11, OUTPUT);  //check with leds + resistance in pwm, this will not work with pins 10 and 11, used by RJ45 shield 
  //pinMode(12, OUTPUT);  //check with leds + resistance in pwm, this will not work with pins 10 and 11, used by RJ45 shield 
  //pinMode(13, OUTPUT);  //check with leds + resistance in pwm, this will not work with pins 10 and 11, used by RJ45 shield 
  //pinMode(14, OUTPUT);  //check with leds + resistance in pwm, this will not work with pins 10 and 11, used by RJ45 shield 
...
void loop() {
  ...
  if(packetSize) {
    ...
    */
    ...
    //Serial.println(buffer_dmx[1]/2);
    analogWrite(A0,buffer_dmx[1]/2);
    //analogWrite(11,buffer_dmx[5]/2);
    //analogWrite(12,buffer_dmx[9]/2);
    //analogWrite(13,buffer_dmx[13]/2);
    //Serial.println(", ");
